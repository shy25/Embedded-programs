 ...
 *           from CMSIS SVD File 'BlueNRG1.svd' Version 1.0,
 *
 * @par      License
 *
 *******************************************************************************************************/
...
/* ---------------------  BlueNRG1 Specific Interrupt Numbers  -------------------- */
  ...
  MFTX1A_IRQn                   =  17,              /*!<  17  Multi functional timer MFTX1 interrupt A                         */
  MFTX1B_IRQn                   =  18,              /*!<  18  Multi functional timer MFTX1 interrupt B                         */
  MFTX2A_IRQn                   =  19,              /*!<  19  Multi functional timer MFTX2 interrupt A                         */
  MFTX2B_IRQn                   =  20,              /*!<  20  Multi functional timer MFTX2 interrupt B                         */
...
typedef struct {                                    /*!< GPIO Structure                                                        */
  ...
  __IO uint32_t  IE;                                /*!< Interrupt mask register (1 bit per IO).<ul><li>0: masked.</li><li>1:
                                                         not masked</li></ul>                                                  */
  ...
  union {
    ...
    struct {
      __IO uint32_t  MFTX1_TIMER_A:  8;             /*!< MFTX1 timer A.<ul><li>0x00: IO0.</li><li>0x01: IO1</li><li>0x02:
                                                         IO2</li><li>...</li><li>0x0E: IO14</li></ul>                          */
      __IO uint32_t  MFTX1_TIMER_B:  8;             /*!< MFTX1 timer B.<ul><li>0x00: IO0.</li><li>0x01: IO1</li><li>0x02:
                                                         IO2</li><li>...</li><li>0x0E: IO14</li></ul>                          */
      __IO uint32_t  MFTX2_TIMER_A:  8;             /*!< MFTX2 timer A.<ul><li>0x00: IO0.</li><li>0x01: IO1</li><li>0x02:
                                                         IO2</li><li>...</li><li>0x0E: IO14</li></ul>                          */
      __IO uint32_t  MFTX2_TIMER_B:  8;             /*!< MFTX2 timer B.<ul><li>0x00: IO0.</li><li>0x01: IO1</li><li>0x02:
                                                         IO2</li><li>...</li><li>0x0E: IO14</li></ul>                          */
    } MFTX_b;                                       /*!< BitSize                                                               */
  };
} GPIO_Type;
...
typedef struct {                                    /*!< UART Structure                                                        */
  ...
  union {
    ...
    struct {
      __IO uint32_t  UARTEN     :  1;               /*!< UART enable. This bit enables the UART.<ul><li>0: UART is disabled.</li><l
    ...
    struct {
      ...
      __IO uint32_t  SPIM       :  2;               /*!< SPI transmission mode.<ul><li>00b: Full duplex mode.</li><li>01b:
                                                         Transmit mode.</li><li>10b: Receive mode.</li><li>11b: Combined
                                                          mode.</li></ul>                                                      */
      __IO uint32_t  INVCLK     :  1;               /*!< Activate inversion (in master mode only).<ul><li>0: Master samples
                                                         the received data respecting the Motorola SPI protocol.</li><li>1:
                                                          The sampling of the received data by master is delayed by half
                                                          an SPI clock cycle..</li></ul>                                       */
    ...
    struct {
      ...
      __IO uint32_t  TXIFLSEL   :  3;               /*!< Transmit interrupt FIFO level select. This bit field selects
                                                         the trigger points to transmit FIFO interrupt:<ul><li>000b:
                                                          ...
                                                          or more.</li><li>Others: Reserved.</li></ul>                         */
      __IO uint32_t  FLOWCTRLEN :  1;               /*!< Flow Control Enable.<ul><li>0: Flow control is disabled.</li><li>1:
                                                         Flow control is enabled.</li></ul>                                    */
...
typedef struct {                                    /*!< ADC Structure                                                         */
  ...
  union {
    ...
    struct {
      ...
      __I  uint8_t   BUSY       :  1;               /*!< 1: during conversion                                                  */
...
typedef struct {                                    /*!< CKGEN_SOC Structure                                                   */
  ...
  union {
    ...
    struct {
      ...
      __I  uint32_t  VERSION    :  5;               /*!< Cut version                                                           */
      __I  uint32_t  PRODUCT    :  3;               /*!< Product                                                               */
    } DIE_ID_b;                                     /*!< BitSize                                                               */
  };
  ...
  union {
    ...
    struct {
      ...
      __IO uint32_t  MFTX1      :  1;               /*!< MFTX1 clock                                                           */
      __IO uint32_t  MFTX2      :  1;               /*!< MFTX2 clock                                                           */
...
typedef struct {                                    /*!< I2C Structure                                                         */
  ...
  union {
    __IO uint16_t  THDSTA_FMP;                      /*!< I2C hold time start condition FMP                                     */
    
    struct {
      __IO uint16_t  THDSTA_FMP :  9;               /*!< Hold time start condition value for FMP mode. When the start
                                                         condition is asserted, the decimeter loads the value of THDSTA_FMP
                                                          for FMP mode, once the THDSTA_FMP value is reached, the SCL
                                                          line asserts low.                                                    */
    } THDSTA_FMP_b;                                 /*!< BitSize                                                               */
  };
  __I  uint16_t  RESERVED9;
  ...
  union {
    __IO uint16_t  TSUSTA_FMP;                      /*!< I2C setup time start condition FMP                                    */
    
    struct {
      __IO uint16_t  TSUSTA_FMP :  9;               /*!< Setup time start condition value for standard mode. After a
                                                         non-stop on the SCL line the decimeter loads the value of TSUSTA_FMP
                                                          according to fast mode plus mode. Once the counter is expired,
                                                          the start condition is generated.                                    */
    } TSUSTA_FMP_b;                                 /*!< BitSize                                                               */
  };
} I2C_Type;
...
typedef struct {                                    /*!< MFTX Structure                                                        */
  ...
  union {
    ...
    struct {
      __O  uint8_t   TNACLR     :  1;               /*!< Clear timer interrupt source A.                                       */
      __O  uint8_t   TNBCLR     :  1;               /*!< Clear timer interrupt source B.                                       */
      __O  uint8_t   TNCCLR     :  1;               /*!< Clear timer interrupt source C.                                       */
      __O  uint8_t   TNDCLR     :  1;               /*!< Clear timer interrupt source D.                                       */
    } TNICLR_b;                                     /*!< BitSize                                                               */
  };
} MFTX_Type;
...
typedef struct {                                    /*!< RTC Structure                                                         */
  ...
  __IO uint32_t  TWK;                               /*!< RTC Timer Wake-up Register                                            */
  __IO uint32_t  SMIN;                              /*!< RTC Timer Sleep-Mode Interrupt Number Register                        */
} RTC_Type;
...
typedef struct {                                    /*!< RNG Structure                                                         */
  ...
  union {
    ...
    struct {
      ...
      __IO uint32_t  TST_CLK    :  1;               /*!< RNG test clock bit. Writing this bit with 1b starts the logic
                                                         that detects the presence of the CLK. Then wait (with a timeout
                                                          of at least four RNGCLK cycles) for REVCLK = 1b in SR register.
                                                          If REVCLK = 0b after timeout elapsed, it means that RNGCLK is
                                                          not present and reading VAL register will trigger an AHB error
                                                          response. For security reason, software should check before
                                                          reading random values that the RNGCLK is present.                    */
    } CR_b;                                         /*!< BitSize                                                               */
  };
  ...
  union {
    ...
    struct {
      ...
      __IO uint32_t  REVCLK     :  1;               /*!< REVCLK clock reveal bit. A write with 1b to bit TSTCLK in CR
                                                         resets this bit. If the RNGCLK is present, this bit will be
                                                          1b after four RNGCLK cycles after the end of the write to RNG_CR.If
                                                          REVCLK = 0b after this period, it means the RNGCLK is not present
                                                          and reading VAL will trigger a AHB error response.                   */
      __IO uint32_t  FAULT      :  1;               /*!< Fault reveal bit. This bit is set by hardware when a faulty
                                                         sequence of bits occurs. The faulty sequences are:<ul><li>0:
                                                          Sequence of more than 32 consecutive bits of same value (0b
                                                          or 1b).</li><li>1: Sequence of more than 16 consecutive alternation
                                                          of 0b and 1b (010101...01b).</li></ul>Writing this bit:<ul><li>0:
                                                          No effect.</li><li>1: Clear the bit.</li></ul>                       */
    } SR_b;                                         /*!< BitSize                                                               */
  };
...
#define MFTX1_BASE                      0x40D00000UL
#define MFTX2_BASE                      0x40E00000UL
...
#define MFTX1                           ((MFTX_Type               *) MFTX1_BASE)
#define MFTX2                           ((MFTX_Type               *) MFTX2_BASE)
