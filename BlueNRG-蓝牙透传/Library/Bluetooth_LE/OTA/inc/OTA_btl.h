...
#define OTA_BASIC_APPLICATION_BASE_OFFSET       (0xE800)   
...
*        Linker option: MEMORY_FLASH_APP_SIZE=0xE800
  */
    ...
    /** @brief  Free space x application starts from  OTA_ServiceManager_Size:  0x1004E800 (sector 29)  to 0x10066FFF (end of sector 77) --> 49 sectors: 98KB */  
    #define OTA_FREE_SPACE_RANGE  {0x10,0x04,0xE8,0x00,0x10,0x06,0x6F,0xFF}; //Flash start: 0x1004E800; Flash end: 0x10066FFF; 
