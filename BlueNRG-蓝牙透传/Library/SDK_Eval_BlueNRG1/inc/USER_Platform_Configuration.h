/**
 * @file    USER_Platform_Configuration_STEVAL_IDB007V3.h
 * @author  AMS VMA RF application team
 * @version V1.0.0
 * @date    September 29, 2015
 * @brief   This file contains definitions for STEVAL IDB007V3 Eval Platform 
 *
...
/**
 * @brief BlueNRG1 Eval Board (STEVAL-IDB007V3) Buttons definitions
 */
...
/**
 * @brief BlueNRG1 Eval Board (STEVAL-IDB007V3) UART definitions
 */
...
/**
 * @brief BlueNRG1 Eval Board (STEVAL-IDB007V3) I2C definitions
 */
...
#define SDK_EVAL_I2C_DMA_TX_ITTC            DMA_IT_TC7

#define SDK_EVAL_I2C_DMA_RX                 DMA_CH6
#define SDK_EVAL_I2C_DMA_RX_ITTC            DMA_IT_TC6

#define SDK_EVAL_I2C_BASE                   I2C2_BASE


/**
 * @brief BlueNRG1 Eval Board (STEVAL-IDB007V3) LEDs definitions
 */
...
/**
 * @brief BlueNRG1 Eval Board (STEVAL-IDB007V3) SPI definitions
 */
