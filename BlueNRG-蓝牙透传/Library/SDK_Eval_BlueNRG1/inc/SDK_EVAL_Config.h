...
/* BlueNRG1 Development platform: STEVAL-IDB007V3 */
#define STEVAL_IDB007V3 3
/* User defined platform */
#define USER_EVAL_PLATFORM 2



#if USER_DEFINED_PLATFORM == STEVAL_IDB007V1
...
/* Adding the symbol USER_DEFINED_PLATFORM=STEVAL_IDB007V3
 * only the STEVAL-IDB007V3 is supported
 */
#include "USER_Platform_Configuration_STEVAL_IDB007V3.h"
#else 
...
enum {
  ...
  ID_STEVAL_IDB007V3,   /* BlueNRG-1 Development platform: STEVAL-IDB007V3 */
};
